...
public class DoublyLinkedList<E> implements LinkedList<E> {
	...
	public DoublyLinkedList() {
        ...
        public DoublyLinkedList divideByHalf(){
            if(isEmpty())
            ...
            Node<E> newAux = aux.getNext();
            
            DoublyLinkedList<E> newList = new DoublyLinkedList<>();
            newList.header.setNext(newAux);
            newAux.setPrev(newList.header);
            newList.trailer.setPrev(trailer.getPrev());
