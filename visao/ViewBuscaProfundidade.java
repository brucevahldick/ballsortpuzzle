...
public class ViewBuscaProfundidade extends javax.swing.JFrame implements Puzzle{
    ...
    public ViewBuscaProfundidade() {
        initComponents();
        setTitle("Ballsort Puzzle - Busca Profundidade");
    }
    ...
    public void setTextPosicaoLabel(String s){
        posicaoProfundidadeLabel.setText(s);
    }
    ...
    private void initComponents() {
        ...
        posicaoProfundidadeLabel = new javax.swing.JLabel();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(posicaoProfundidadeLabel)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private javax.swing.JLabel posicaoProfundidadeLabel;
